...
static partial class Helpers
{
	...
	{
		Assert( !argumentParser.Arguments.OfType<VerbArgument>().Any(), //
			() => throw new InvalidArgumentOrderingException( ArgumentOrderingRule.ArgumentMustPrecedeVerb, name, verbTerm ) );
		return true;
	}
}
